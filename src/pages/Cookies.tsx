...
export function CookiesPage() {
  ...
  const sections = dictionary.cookies.page.sections

  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-20">
      <PageHeader
        eyebrow={t('cookies.page.eyebrow')}
        title={t('cookies.page.title')}
        description={t('cookies.page.description', vars)}
      />

      <p className="mt-8 text-sm text-moove-muted">{t('cookies.page.lastUpdated')}</p>
